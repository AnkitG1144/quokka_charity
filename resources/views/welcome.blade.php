...
<body class="antialiased">
    ...
    <section style="background-color: #eee;">
        <div class="container py-5">
            <div class="row">
                @foreach($allActiveRequest as $aAR)
                <div class="col-md-12 col-lg-4 mb-4 mb-lg-0 rounded-2">
                    <div class="card">
                        <div class="d-flex justify-content-between p-3 mb-0">
                            ...
                            <div class="bg-info rounded d-flex align-items-center justify-content-center shadow-1-strong p-2" style="width: auto; height: 35px;">
                                <p class="text-white mb-0 small">Highest</p>
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between mb-2">
                                ...
                                <p class="text-muted mb-0">Supporters: <span class="fw-bold">6</span></p>
                            </div>
                            @if(!Auth::check())
                            <div>
                                <button type="button" class="btn btn-primary" style="width: 100%">Support by Paytm</button>
                            </div>
                            @endif
                        </div>
                    </div>
